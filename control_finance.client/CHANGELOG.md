...
- Crie um projeto react com create-vite: `npm init --yes vite@latest control_finance.client -- --template=react`.
...
- Criar o arquivo de projeto (`control_finance.client.esproj`).
